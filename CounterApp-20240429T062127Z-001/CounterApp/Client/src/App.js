...
// //   //const [state, dispatch] = useReducer(counterReducer, { count: {state.count}, mycount: {state.mycount} });
...
import React, { useState, useEffect, useContext, useReducer, useCallback } from 'react';
import { BrowserRouter as Router, Routes, Route, Link, useNavigate } from 'react-router-dom';import axios from 'axios';
